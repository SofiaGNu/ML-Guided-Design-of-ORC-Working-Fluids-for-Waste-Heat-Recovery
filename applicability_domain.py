...
class ApplicabilityDomain():
    def __init__(self, method_name='lof', rate_of_outliers=0.05, gamma='auto', nu=0.5, n_neighbors=5,
                 metric='minkowski', p=2, coverage_threshold=0.8):
        """
    ...
    def fit(self, x):
        ...
        if self.method_name == 'ocsvm':
            ...
            self.ad = NearestNeighbors(n_neighbors=self.n_neighbors, metric='manhattan') #manhattan metric added for groups 
            self.ad.fit(x)
